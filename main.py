...
voc = jv_combined.get_x_at(0)
jsc = jv_combined.get_y_at(0)
ff = power_combined.peak_y()[1] / (voc * jsc)
voc_corrected = jv_combined_corrected.get_x_at(0)
jsc_corrected = jv_combined_corrected.get_y_at(0)
ff_corrected = power_combined_corrected.peak_y()[1] / (voc_corrected * jsc_corrected)
print(f"{voc=}")
print(f"{jsc=}")
print(f"{ff=}")
print(f"{voc_corrected=}")
print(f"{jsc_corrected=}")
print(f"{ff_corrected=}")
